...
sightings:
  ...
  - {
      ...
      sourceUrl: 'https://www.njstatelib.org/',
    }
  - {
      name: 'Woodbury, NJ',
      lat: 39.838,
  ...
  - {
      name: 'Galloway Township, NJ',
      lat: 39.49,
      lon: -74.45,
      year: 2015,
      label: 'Photograph posted to social media; widely circulated',
      sourceUrl: 'https://www.smithsonianmag.com/history/real-story-jersey-devil-180959299/',
    }
  - {
      ...
      lon: -74.61,
      year: 1957,
      label: 'Forest service investigation of livestock kills',
      sourceUrl: 'https://www.smithsonianmag.com/history/real-story-jersey-devil-180959299/',
    }
---
...
<Section heading="Before We Begin">
  ...
  <p>
    This journal entry of the Monster Survival Guide concerns the oldest monster in America. The one
    that flew over the cradle of the republic. The thirteenth child of Mother Leeds.
  </p>
</Section>
...
<Section heading="What You Are Looking At">
  ...
  />
  <p>
    The Jersey Devil is the most chimeric creature in this guide. Eyewitnesses across nearly three
...
<Section heading="Before You Go">
  <Outro>
    ...
    <p>
      End of journal entry. Stay out of the pines. Stay sceptical. And remember — the oldest monster
      in America is also the one most people stop believing in just before they encounter it.
    </p>
  </Outro>
</Section>
