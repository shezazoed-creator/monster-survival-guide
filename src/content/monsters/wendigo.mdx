...
sightings:
  - {
      name: 'Fort Saskatchewan, Alberta',
      lat: 53.71,
      lon: -113.21,
      year: 1879,
      label: 'Swift Runner case · first legal execution in Alberta',
      sourceUrl: 'https://www.executedtoday.com/2014/12/20/1879-swift-runner-wendigo/',
    }
  - {
      name: 'Sandy Lake, Ontario',
      lat: 53.05,
      lon: -93.32,
      year: 1907,
      label: 'Jack Fiddler — “the Wendigo Hunter”',
      sourceUrl: 'https://en.wikipedia.org/wiki/Jack_Fiddler',
    }
  - {
      name: 'Roseau, Minnesota',
      lat: 48.85,
      lon: -95.76,
      year: 1888,
      label: 'Documented Wendigo psychosis case · Ojibwe community',
      sourceUrl: 'https://en.wikipedia.org/wiki/Wendigo_psychosis',
    }
  - {
      name: 'Trout Lake, Ontario',
      lat: 51.27,
      lon: -93.3,
      year: 1899,
      label: 'Sucker River Anishinaabe — recorded by anthropologists',
      sourceUrl: 'https://en.wikipedia.org/wiki/Wendigo',
    }
  - {
      name: 'Algonquian boreal cluster',
      lat: 49.5,
      lon: -82.0,
      label: 'Ojibwe / Cree / Innu / Naskapi territory · centuries of cultural record',
      sourceUrl: 'https://www.britannica.com/topic/wendigo',
    }
---
