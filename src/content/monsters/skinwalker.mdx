...
sightings:
  - {
      ...
      sourceUrl: 'https://www.britannica.com/topic/skin-walker',
    }
  - {
  ...
  - {
      ...
      sourceUrl: 'https://www.legendsofamerica.com/skinwalker-ranch/',
    }
  - {
      ...
      lon: -102.55,
      year: 1996,
      label: 'Lakota community reports — distinct tradition; included for breadth',
      sourceUrl: 'https://www.britannica.com/topic/skin-walker',
    }
  - {
      name: 'Tony Hillerman territory, Four Corners',
      lat: 36.99,
      lon: -109.04,
      label: 'Documented in Leaphorn / Chee mystery series consulted with Diné advisors',
      sourceUrl: 'https://www.britannica.com/topic/skin-walker',
    }
---
...
export const rules = [
  {
    ...
    body: 'Especially not in the homes or vehicles of Diné people. Especially not at night. The cultural prohibition is the entire defensive doctrine of this journal entry. Honour it.',
  },
  {
...
<div class="cultural-note">
  <p>
    This journal entry concerns a being from the sacred tradition of the Diné — the Navajo Nation.
    Within traditional Diné belief, public discussion of this entity is considered both
    inappropriate and dangerous. To speak its name openly, to ask elders about it, or to study it
    from outside the culture is, in many traditional teachings, to invite its attention.
  </p>
  <p>
    We are not Diné. We are presenting this journal entry because the entity is referenced widely in
    popular folklore, and because uninformed engagement with its legend has produced real harm. We
    have therefore made three editorial decisions:{' '}
    <strong>
...
<Section heading="Before We Begin">
  ...
  <p>
    This journal entry of the Monster Survival Guide does something the others do not. We write
    carefully. We write briefly. And we are honest about the limits of what we, the people writing
    this guide, are entitled to say.
  </p>
</Section>
...
<Section heading="Where It Comes From">
  ...
  <p>
    ...
    and they are not the subject of this journal entry.
  </p>
</Section>
...
<Section heading="Before You Go">
  <Outro>
    <p>
      ...
      Skinwalker is something we, the people writing this guide, are not entitled to fully describe
    ...
    <p>
      ...
      tell us, and we will correct it. The point of this journal entry is not to add to the noise.
      The point is to slow it down.
    </p>
    <p>
      If you are not Diné and you are reading this, the most useful thing this journal entry can do
      is encourage you to do less, not more. Do not visit the Ranch. Do not bring the topic to
      dinner. Do not buy the merchandise. Do not say the name as a joke. The tradition has lasted
      for centuries because it was carefully maintained. Help it last by leaving it alone.
    </p>
    <p>
      End of journal entry. Stay quiet about this one. Stay sceptical. And if you hear a voice you
      recognise calling from outside in the dark — <em>do not answer it.</em>
    </p>
  </Outro>
</Section>
