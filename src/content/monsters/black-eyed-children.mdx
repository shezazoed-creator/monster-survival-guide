...
sightings:
  - {
      ...
      lon: -99.733,
      year: 1996,
      label: 'Brian Bethel encounter — patient zero',
      sourceUrl: 'https://www.historicmysteries.com/myths-legends/brian-bethel-black-eyed-kids/878/',
    }
  - {
      name: 'Cannock Chase, Staffordshire',
      lat: 52.74,
      lon: -2.0,
      year: 2014,
      label: 'Brickley research cluster · Daily Star coverage',
      sourceUrl: 'https://en.wikipedia.org/wiki/Black-eyed_children',
    }
  - {
      ...
      lon: 1.13,
      year: 2018,
      label: 'Fisherman account — children at the waterline',
      sourceUrl: 'https://www.atlasobscura.com/articles/black-eyed-children-urban-legend',
    }
  - {
      name: 'Suffolk coast, England',
      lat: 52.18,
      lon: 1.62,
      year: 2019,
      label: 'Lifeboat-station knock · tide-line approach',
      sourceUrl: 'https://www.atlasobscura.com/articles/black-eyed-children-urban-legend',
    }
  - {
      name: 'Vermont, USA',
      ...
      lon: -72.7,
      year: 2013,
      label: 'BEK approach to remote farmhouse (Daily Star international coverage)',
      sourceUrl: 'https://www.atlasobscura.com/articles/black-eyed-children-urban-legend',
    }
  - {
      name: 'Portsmouth, Ohio',
      lat: 38.73,
      lon: -82.99,
      year: 2012,
      label: 'Apartment-knock account — parking-lot witness',
      sourceUrl: 'https://en.wikipedia.org/wiki/Black-eyed_children',
    }
  - {
      name: 'Yass, NSW, Australia',
      lat: -34.84,
      lon: 148.91,
      year: 2017,
      label: 'Roadside BEK report — Australian paranormal archive',
      sourceUrl: 'https://en.wikipedia.org/wiki/Black-eyed_children',
    }
---
